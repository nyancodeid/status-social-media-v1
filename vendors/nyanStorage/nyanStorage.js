function nyanStorageContructor() {
...
nyanStorageContructor.prototype.api = function() {
	console.log("APIIII");

	return this;
}
nyanStorageContructor.prototype.isAvailable = function(key) {
	return (localStorage.getItem(key) == null) ? false : true;
}
nyanStorageContructor.prototype.get = function(key) {
...
nyanStorageContructor.prototype.put = function(key, data) {
	var content;
...
nyanStorageContructor.prototype.clear = function() {
